...
1. Run the script:
   ...
   Please enter the time (YYYY-MM-DD HH:MM:SS) or ENTER if you want current time:
   ```
...
- **YOU CAN HANG LAUNDRY[Enter city, time]:**
  ```
  This tool helps you decide if it's a suitable day for hanging laundry.
  ...
  Wind Speed: 1.51 m/s
  ```
- **YOU CAN HANG LAUNDRY[Enter only city]:**
  ```
  This tool helps you decide if it's a suitable day for hanging laundry.
  ______________________________________________________________________
  Please enter the city (e.g. Bangkok): bangkok
  Please enter the time (YYYY-MM-DD HH:MM:SS) or ENTER if you want current time:
  No time entered. Using current time: 2024-12-24 19:03:55
  >>>No rain within 24 hours from the specified time. YOU CAN HANG LAUNDRY!
  Weather details
  ___________________________
  Temperature: 28.28°C
