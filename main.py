...
def main():
    ...
    parser.add_argument("--take-things", action="store_true", help="Recommend Item that should be carry in the weather.")
    parser.add_argument("--laundry", action="store_true", help="Helps you decide if it's a suitable day for hanging laundry.")
